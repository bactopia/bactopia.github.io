...
|----------|-------------|
| staphtyper-dag.dot | The Nextflow [DAG visualisation](https://docs.seqera.io/nextflow/reports#dag-visualisation) |
| staphtyper-report.html | The Nextflow [Execution Report](https://docs.seqera.io/nextflow/reports#execution-report) |
| staphtyper-timeline.html | The Nextflow [Timeline Report](https://docs.seqera.io/nextflow/reports#timeline-report) |
| staphtyper-trace.txt | The Nextflow [Trace](https://docs.seqera.io/nextflow/reports#trace-report) report |
