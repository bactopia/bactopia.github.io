...
code base, almost from scratch (_which is not necessarily a bad thing!_). As you can see in the
...
ways for me to verify my guardrails are being followed. With the introduction of strict syntax and
record types, I was able to incorporate numerous patterns that are well suited to LLMs and these
guardrails I’ve set up. Either way, I will still be very much involved in reviewing any changes
made by LLMs. I just wanted to briefly mention my stance on the usage of AI to help co-develop Bactopia.

![Bactopia's AI Feedback Loop](./img/image2.png)

I feel a more lengthy post is still needed to better demonstrate my process when using LLMs for
