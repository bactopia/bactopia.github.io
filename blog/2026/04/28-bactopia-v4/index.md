...
You might be wondering what’s new in Bactopia? And well the answer is ***a lot***, but
also… ***not a lot*** (!?) How can that be? Well, about that…
...
So, to answer your first question: *how did Bactopia change a lot, without changing a lot?*

Well, in order to implement strict syntax and record types, I had to essentially rewrite the
code base, almost from scratch (*which is not necessarily a bad thing!*). As you can see the
...
[Seqera](https://seqera.io/) (*who maintain Nextflow*) for getting that implemented!

## Co-development with AI

[can you write a message about the usage of llms in Bactopia] Haha, just kidding, its still me
writing this post! But, on a more serious note, ***going forward Bactopia will be utilizing AI in
the future developments and maintenance***. I’m the only developer and maintainer of Bactopia, so I
...
Bactopia. Trust me (*not like the “trust me bro” trust me*), but trust me, Bactopia is something I
care about deeply, and I plan to continue maintaining ownership of it. I’ve gone through extensive
efforts to ensure there are specific guardrails for AI follow, as well as ways for me to verify my
guardrails are being followed. With the introduction of strict syntax and record types, I was able
to incorporate numerous patterns that are well suited to LLMs and these guardrails I’ve set up.
Either way, I will still be very much involved in reviewing any changes made by LLMs. I just wanted
...
rewrite didn’t move the dial much, but that’s a good thing. You might be wondering, how is all this
...
pipeline and into *bactopia-py* and *nf-plugin*.
...
All this (*actually that wasn’t too much compared to the [CHANGELOG](https://github.com/bactopia/bactopia/blob/master/CHANGELOG.md#v400-bactopiabactopia-cream-puff-20260429)!*)
, to say:

*If you are a user of Bactopia, what you need to take away is, I now find Bactopia much easier
to build and maintain. Tim and I are in the kitchen cooking up some fun things for the future
of Bactopia. So keep an eye out!*
...
me on the Bactopia Slack workspace (haha which I actually created ages ago!)

PS, PS, Also there's Slack now for Bactopia! (*haha funny story, I actually made it back in
2021*) Check it out: https://bactopia.io/slack
