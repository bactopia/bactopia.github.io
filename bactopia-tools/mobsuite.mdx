...
|----------|-------------|
| mobsuite-dag.dot | The Nextflow [DAG visualization](https://docs.seqera.io/nextflow/reports#workflow-diagram) |
| mobsuite-report.html | The Nextflow [Execution Report](https://docs.seqera.io/nextflow/reports#execution-report) |
| mobsuite-timeline.html | The Nextflow [Timeline Report](https://docs.seqera.io/nextflow/reports#execution-timeline) |
| mobsuite-trace.txt | The Nextflow [Trace](https://docs.seqera.io/nextflow/reports#trace-file) report |
...
| `--mobsuite_opts` | string |  | Extra MOB-suite options in quotes. Example: '--min_mob_evalue 0.001' |
