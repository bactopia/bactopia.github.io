...
|----------|-------------|
| gamma-dag.dot | The Nextflow [DAG visualization](https://docs.seqera.io/nextflow/reports#workflow-diagram) |
| gamma-report.html | The Nextflow [Execution Report](https://docs.seqera.io/nextflow/reports#execution-report) |
| gamma-timeline.html | The Nextflow [Timeline Report](https://docs.seqera.io/nextflow/reports#execution-timeline) |
| gamma-trace.txt | The Nextflow [Trace](https://docs.seqera.io/nextflow/reports#trace-file) report |
...
| `--gamma_all_matches` | boolean | `false` | Include all gene matches, even overlaps |
| `--gamma_extended` | boolean | `false` | Writes out all protein mutations |
| `--gamma_write_fasta` | boolean | `false` | Write FASTA of gene matches |
| `--gamma_write_gff` | boolean | `false` | Write gene matches as GFF file |
