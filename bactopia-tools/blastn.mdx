...
|----------|-------------|
| blastn-dag.dot | The Nextflow [DAG visualization](https://docs.seqera.io/nextflow/reports#workflow-diagram) |
| blastn-report.html | The Nextflow [Execution Report](https://docs.seqera.io/nextflow/reports#execution-report) |
| blastn-timeline.html | The Nextflow [Timeline Report](https://docs.seqera.io/nextflow/reports#execution-timeline) |
| blastn-trace.txt | The Nextflow [Trace](https://docs.seqera.io/nextflow/reports#trace-file) report |
...
| `--blastn_use_genes` | boolean | `false` | Blast against genes sequences instead of contigs |
