...
| Parameter | Description |
|:---|---|
| ` --midas_db` | A single tarball or path to a MIDAS formatted database <br/>**Type:** `string` |
| ` --midas_word_size` | Word size for BLAST search <br/>**Type:** `integer`, **Default:** `28` |
| ` --midas_aln_cov` | Discard reads with alignment coverage < ALN_COV <br/>**Type:** `number`, **Default:** `0.75` |
| ` --midas_opts` | Extra MIDAS options <br/>**Type:** `string` |
| ` --midas_debug` | Keep all temporary files created by MIDAS <br/>**Type:** `boolean` |
