---
title: midas
description: A Bactopia Tool which uses MIDAS to estimate the abundance of bacterial species in a sample. 
...
Below is the default output structure for the `midas` tool. Where possible the 
...
|-------------------------------|-------------|
| midas.tsv | A summary of the MIDAS results for all samples |
...
| Filename                      | Description |
|-------------------------------|-------------|
| &lt;SAMPLE_NAME&gt;.midas.abundances.txt | A TSV file containing the abundance of each bacterial species in the sample |
| &lt;SAMPLE_NAME&gt;.midas.adjusted.abundances.txt | A TSV file containing the abundance of each bacterial species in the sample (adjusted for unclassified reads) |
| &lt;SAMPLE_NAME&gt;.midas.tsv | A TSV file containing the abundance of each bacterial species in the sample |
...
| Filename | Description |
|----------|-------------|
| midas-dag.dot | The Nextflow [DAG visualisation](https://www.nextflow.io/docs/latest/tracing.html#dag-visualisation) |
| midas-report.html | The Nextflow [Execution Report](https://www.nextflow.io/docs/latest/tracing.html#execution-report) |
| midas-timeline.html | The Nextflow [Timeline Report](https://www.nextflow.io/docs/latest/tracing.html#timeline-report) |
| midas-trace.txt | The Nextflow [Trace](https://www.nextflow.io/docs/latest/tracing.html#trace-report) report |
...
### <i class="fa-xl fas fa-exclamation-circle"></i> MIDAS species Parameters


| Parameter | Description |
|:---|---|
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --midas_db` | A single tarball or path to a MIDAS formatted database <br/>**Type:** `string` |
| <i class="fa-lg fas fa-angle-double-down"></i>` --midas_word_size` | Word size for BLAST search <br/>**Type:** `integer`, **Default:** `28` |
| <i class="fa-lg fas fa-angle-double-down"></i>` --midas_aln_cov` | Discard reads with alignment coverage < ALN_COV <br/>**Type:** `number`, **Default:** `0.75` |
| <i class="fa-lg fas fa-italic"></i>` --midas_opts` | Extra MIDAS options <br/>**Type:** `string` |
| <i class="fa-lg fas fa-italic"></i>` --midas_debug` | Keep all temporary files created by MIDAS <br/>**Type:** `boolean` |
...
## Citations
If you use Bactopia and `midas` in your analysis, please cite the following.
