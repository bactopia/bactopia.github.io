---
title: legsta
description: A Bactopia Tool which uses legsta for _in silico_ _Legionella pneumophila_ Sequence Based Typing (SBT).
---
...
Below is the default output structure for the `legsta` tool. Where possible the 
...
!!! info "Directory structure might be different"
    ...
    `legsta` is available as a standalone Bactopia Tool, as well as from
    the main Bactopia workflow (e.g. through Staphopia or Merlin). If executed 
    from Bactopia, the `legsta` directory structure might be different, but the
...
|-------------------------------|-------------|
| legsta.tsv | A tab-delimited file with `legsta` results from all samples |
...
| Filename | Description |
|----------|-------------|
| legsta-dag.dot | The Nextflow [DAG visualisation](https://www.nextflow.io/docs/latest/tracing.html#dag-visualisation) |
| legsta-report.html | The Nextflow [Execution Report](https://www.nextflow.io/docs/latest/tracing.html#execution-report) |
| legsta-timeline.html | The Nextflow [Timeline Report](https://www.nextflow.io/docs/latest/tracing.html#timeline-report) |
| legsta-trace.txt | The Nextflow [Trace](https://www.nextflow.io/docs/latest/tracing.html#trace-report) report |
...
## Citations
If you use Bactopia and `legsta` in your analysis, please cite the following.
