...
### <i class="fa-xl fa-solid fa-toolbox"></i> sra-human-scrubber Parameters


| Parameter | Description |
|:---|---|
| <i class="fa-lg fas fa-file-alt"></i>` --skip_scrubber` | Skip human read scrubbing <br/>**Type:** `boolean` |
