...
| Parameter | Description |
|:---|---|
| ` --pf_mincov` | Minimum percent coverage to be considered a hit <br/>**Type:** `number`, **Default:** `0.6` |
| ` --pf_threshold` | Minimum threshold for identity <br/>**Type:** `number`, **Default:** `0.9` |
