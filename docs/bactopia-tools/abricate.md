...
| Parameter | Description |
|:---|---|
| ` --abricate_db` | Database to use <br/>**Type:** `string`, **Default:** `ncbi` |
| ` --minid` | Minimum DNA percent identity <br/>**Type:** `integer`, **Default:** `80` |
| ` --mincov` | Minimum DNA percent coverage <br/>**Type:** `integer`, **Default:** `80` |
