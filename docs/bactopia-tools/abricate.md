...
| Filename                      | Description |
|-------------------------------|-------------|
| &lt;SAMPLE_NAME&gt;.txt | A tab-delimited report of hits, for full details please see [Abricate - Output](https://github.com/tseemann/abricate#output) |
...
### <i class="fa-xl fas fa-exclamation-circle"></i> Abricate Parameters


| Parameter | Description |
|:---|---|
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --abricate_db` | Database to use <br/>**Type:** `string`, **Default:** `ncbi` |
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --minid` | Minimum DNA percent identity <br/>**Type:** `integer`, **Default:** `80` |
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --mincov` | Minimum DNA percent coverage <br/>**Type:** `integer`, **Default:** `80` |
