...
| Filename                      | Description |
|-------------------------------|-------------|
| &lt;SAMPLE_NAME&gt;.fasta | Annotated gene sequences is FASTA format |
| &lt;SAMPLE_NAME&gt;.gamma | A TSV file with annotated gene matches |
| &lt;SAMPLE_NAME&gt;.gff | Annotated gene matches is GFF3 format |
| &lt;SAMPLE_NAME&gt;.psl | A PSL file with BLAT gene alignments |
...
### <i class="fa-xl fas fa-exclamation-circle"></i> GAMMA Parameters


| Parameter | Description |
|:---|---|
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --gamma_db` | A gene database (FASTA) for GAMMA <br/>**Type:** `string` |
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --percent_identity` | The minimum nucleotide sequence identiy % used by the Blat search <br/>**Type:** `integer`, **Default:** `90` |
| <i class="fa-lg fas fa-italic"></i>` --all_matches` | Include all gene matches, even overlaps <br/>**Type:** `boolean` |
| <i class="fa-lg fas fa-italic"></i>` --extended` | Writes out all protein mutations <br/>**Type:** `boolean` |
| <i class="fa-lg fas fa-italic"></i>` --write_fasta` | Write FASTA of gene matches <br/>**Type:** `boolean` |
| <i class="fa-lg fas fa-italic"></i>` --write_gff` | Write gene matches as GFF file <br/>**Type:** `boolean` |
