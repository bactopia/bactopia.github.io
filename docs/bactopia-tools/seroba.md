...
### <i class="fa-xl fas fa-exclamation-circle"></i> Seroba Parameters


| Parameter | Description |
|:---|---|
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --seroba_noclean` | Do not clean up intermediate files <br/>**Type:** `boolean` |
| <i class="fa-lg fas fa-expand-arrows-alt"></i>` --seroba_coverage` | Threshold for k-mer coverage of the reference sequence <br/>**Type:** `integer`, **Default:** `20` |
