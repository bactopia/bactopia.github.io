...
| Parameter | Description |
|:---|---|
| ` --seroba_noclean` | Do not clean up intermediate files <br/>**Type:** `boolean` |
| ` --seroba_coverage` | Threshold for k-mer coverage of the reference sequence <br/>**Type:** `integer`, **Default:** `20` |
