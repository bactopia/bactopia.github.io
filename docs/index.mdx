---
title: Bactopia
description: An end-to-end workflow Nextflow pipeline for bacterial genome analysis.
slug: /
sidebar_position: 0
...
<div style={{textAlign: 'center', padding: '4rem 2rem'}}>
  ...
  <span style={{fontSize: '1.25rem', color: 'var(--ifm-color-emphasis-700)', maxWidth: '700px', margin: '0 auto', display: 'block'}}>
    An end-to-end workflow Nextflow pipeline for bacterial genome analysis.
  </span>
</div>
