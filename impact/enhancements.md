...
Sometimes overlooked, its important to reiterate, every recipe added to Bioconda has a
...
I decided to require each Bactopia Tool must have a corresponding module be available from
nf-core/modules. If such a module is not already available, it will be added.
