...
| Parameter | Description |
|:---|---|
| ` --contig_thresholds` | Comma-separated list of contig length thresholds <br/>**Type:** `string`, **Default:** `0,1000,10000,100000,250000,1000000` |
| ` --plots_format` | Save plots in specified format <br/>**Type:** `string`, **Default:** `pdf` |
