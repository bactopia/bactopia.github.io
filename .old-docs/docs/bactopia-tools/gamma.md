...
| Parameter | Description |
|:---|---|
| ` --gamma_db` | A gene database (FASTA) for GAMMA <br/>**Type:** `string` |
| ` --percent_identity` | The minimum nucleotide sequence identiy % used by the Blat search <br/>**Type:** `integer`, **Default:** `90` |
| ` --all_matches` | Include all gene matches, even overlaps <br/>**Type:** `boolean` |
| ` --extended` | Writes out all protein mutations <br/>**Type:** `boolean` |
| ` --write_fasta` | Write FASTA of gene matches <br/>**Type:** `boolean` |
| ` --write_gff` | Write gene matches as GFF file <br/>**Type:** `boolean` |
