...
| Parameter | Description |
|:---|---|
| ` --kmer` | kmer size (<= 16) for ANI calculation <br/>**Type:** `integer`, **Default:** `16` |
| ` --min_fraction` | Minimum fraction of genome that must be shared for trusting ANI. <br/>**Type:** `number`, **Default:** `0.2` |
| ` --frag_len` | fragment length <br/>**Type:** `integer`, **Default:** `3000` |
| ` --skip_pairwise` | Only use RefSeq or local assemblies for ANI calculations <br/>**Type:** `boolean` |
