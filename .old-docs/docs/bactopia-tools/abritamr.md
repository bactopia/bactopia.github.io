...
| Parameter | Description |
|:---|---|
| ` --abritamr_species` | Use species specific point mutations, must provide a valid species <br/>**Type:** `string` |
| ` --abritamr_identity` | Minimum identity of matches with amrfinder (0 - 1.0), defaults to amrfinder preset <br/>**Type:** `integer` |
